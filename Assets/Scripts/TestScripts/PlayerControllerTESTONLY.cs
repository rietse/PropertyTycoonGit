...
public class PlayerControllerTESTONLY : MonoBehaviour
{
    ...
    public void SellProperty(int player)
    {
        ...
        else print("Can't sell the space " + currentPos + "!");
    }
    ...
    public void MortgageProperty(int player)
    {
        ...
        {
            print("Can't mortgame/unmortgage space " + currentPos + "!");
        }
    }
    ...
    public void UpgradeProperty(int player)
    {
        ...
        if (CheckMonopoly(property.GetComponent<Property>().GetColour(), currentPos) == true)
        {
